...
public:
    ...
    struct dataStruct {
           ...
           uint32_t bandEdges[3][2];
           uint32_t endPositions[3][2] = {{10,11},{12,13},{14,15}};
           uint32_t presets[3][6];
           uint32_t initialized = 0x55555551;
    };
    ...
    // Pointer to the FLASH memory.  This will be used for byte-for-byte storage of a C++ struct.
    const uint8_t *flash_target_contents = (const uint8_t *) (XIP_BASE + FLASH_TARGET_OFFSET);
    dataStruct eepromData;
    dataStruct readStruct;
